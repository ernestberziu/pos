...
<table width="100%">
    ...
    <tbody>
    ${order.map(item => `<tr><td  style="font-size:14px; font-weight:bold">` + (item.name || item.product_name) + "</td><td>" + item.quantity + "</td><td>" + settings.symbol + parseFloat(item.price).toFixed(2) + "</td></tr>").join('')}
<tr>
    <td><b>Nentotali</b></td>
    <td>:</td>
